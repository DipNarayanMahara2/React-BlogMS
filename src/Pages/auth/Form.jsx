      ...
      <div className="min-h-screen flex flex-col items-center justify-center py-6 px-4">
        <div className="max-w-md w-full">
          <div className="p-8 rounded-2xl bg-white shadow">
            <h2 className="text-slate-600 text-center text-4xl font-semibold">
              {type}
            </h2>
              ...
              {type === "Register" && (
                <div>
                  ...
                  <div className="relative flex items-center">
                    ...
                    >
                      <path
                        d="M20 4H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2zm0 2v.01L12 13 4 6.01V6h16zM4 18V8.08l7.39 5.77a1 1 0 0 0 1.22 0L20 8.08V18H4z"
                        data-original="#000000"
                      />
                    </svg>
                  </div>
